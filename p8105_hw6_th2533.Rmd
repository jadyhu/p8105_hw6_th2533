...
```
The 95% CI limit for log_coef is between `r quantile(bootstrap_logestimates$log_coef,probs=0.025)` and `r quantile(bootstrap_logestimates$log_coef,probs=0.975)`
